  ...
  if (workCarousel) {
    ...
    var WORK_PROJECTS = [
      { title: 'Fundación La Libertad', url: 'https://lalibertadcr.org/',
        desc: { es: 'Parque y centro comunitario que ofrece espacios para el deporte, la formación y una amplia variedad de cursos para la comunidad.',
                en: 'A community park and center offering spaces for sports, education, and a wide range of courses for the local community.' } },
      { title: 'Parker & Sons', url: 'https://www.parkerandsons.com/',
        desc: { es: 'Proyecto web desarrollado en colaboración con otras agencias para una empresa líder en servicios para el hogar.',
                en: 'A web project developed in collaboration with other agencies for a leading home services company.' } },
      { title: 'Moonleaf Cleaning', url: 'https://chaperslab.github.io/moonleaf-cleaning/',
        desc: { es: 'Sitio web creado para una empresa especializada en servicios profesionales de limpieza.',
                en: 'A website created for a company specializing in professional cleaning services.' } },
      { title: "Boothe's", url: 'https://www.boothehvac.com/',
        desc: { es: 'Proyecto web desarrollado en colaboración con otras agencias para una empresa especializada en HVAC, plomería y servicios eléctricos.',
                en: 'A web project developed in collaboration with other agencies for a company specializing in HVAC, plumbing, and electrical services.' } }
    ];
